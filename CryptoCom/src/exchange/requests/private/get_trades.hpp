...
class GetTrades : public BaseRequest
{
private:
    const std::string method = "private/get-trades";
...
public:
    GetTrades(std::string instrument_name = "", long start_ts = 0, long end_ts = 0, int page_size = 0, int page = 0)
        : BaseRequest()
    {
